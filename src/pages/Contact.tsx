          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="bg-gradient-primary rounded-2xl p-8 shadow-elegant">
              <div className="flex items-center mb-8">
                ...
                <h2 className="text-heading text-3xl text-foreground">
                  Tell Us Your Story
                </h2>
              </div>
            ...
            <div className="space-y-8">
              <div className="bg-gradient-ethereal rounded-2xl p-8 shadow-soft">
                <h3 className="text-heading text-2xl mb-6 text-foreground">
                  Get in Touch
                </h3>
              ...
              <div className="bg-background/80 backdrop-blur-sm rounded-2xl p-8 shadow-soft">
                <h3 className="text-heading text-2xl mb-4 text-foreground">
            ...
            {[
              {
                ...
                answer: "We recommend booking 6-12 months in advance for weddings, especially during peak season (April-October). However, we've successfully planned beautiful celebrations with shorter timelines too."
              },
              {
                question: "Do you offer customizable packages?",
                answer: "Absolutely! Every celebration is unique, and we tailor our services to match your specific needs, style, and budget. We offer both full-service packages and individual services."
              },
              {
                question: "Can you work with our budget?",
                answer: "Yes, we work with various budgets and will help you prioritize elements that matter most to you. During our consultation, we'll discuss how to maximize your investment."
              },
              {
                question: "Do you handle destination events?",
                answer: "Yes, we love destination celebrations! We've planned events across the country and internationally. Additional travel costs will be discussed during planning."
              }
            ].map((faq, index) => (
              <div key={index} className="bg-background/80 backdrop-blur-sm rounded-2xl p-6 shadow-soft">
                <h4 className="text-heading text-lg mb-3 text-foreground">
                  {faq.question}
                </h4>
                <p className="text-body text-foreground/80">
                  {faq.answer}
