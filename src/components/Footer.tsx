      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-body text-background/80 mb-6 max-w-md leading-relaxed">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-accent/20 rounded-full flex items-center justify-center hover:bg-accent/30 transition-colors duration-200">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["About Us", "Services", "Portfolio", "Testimonials", "Contact"].map((link) => (
                <li key={link}>
                  <a href="#" className="text-body text-background/70 hover:text-background transition-colors duration-200">
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-body text-background/80">+1 (555) 123-4567</span>
              </div>
              <div className="flex items-center">
                <Mail className="w-5 h-5 text-accent mr-3" />
                <span className="text-body text-background/80">hello@thefirstknot.com</span>
              </div>
              <div className="flex items-start">
                <MapPin className="w-5 h-5 text-accent mr-3 mt-1" />
                <span className="text-body text-background/80">123 Wedding Street, Love City, LC 12345</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-background/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-body text-background/70 mb-4 md:mb-0">
